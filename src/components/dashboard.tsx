          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-6 bg-gray-50 p-4 rounded-lg">
                <h3 className="text-sm font-medium text-gray-900 mb-2">Token Info</h3>
                <p className="text-xs text-gray-500 break-all">
                  Access Token: {accessToken ? `${accessToken.substring(0, 50)}...` : 'No token'}
                </p>
              </div>
                  ...
                  <div className="p-5">
                    <div className="flex items-center">
                      ...
                      <div className="ml-5 w-0 flex-1">
                        <dl>
                          <dt className="text-sm font-medium text-gray-500 truncate">Secure Access</dt>
                          <dd className="text-lg font-medium text-gray-900">JWT Protected</dd>
                        </dl>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-yellow-50 overflow-hidden shadow rounded-lg">
                  <div className="p-5">
                    <div className="flex items-center">
                      ...
                      <div className="ml-5 w-0 flex-1">
                        <dl>
                          <dt className="text-sm font-medium text-gray-500 truncate">Refresh Token</dt>
